...
/**
 * Event: byblos submission created.
 *
...
class submission_created extends base {
    ...
    public static function get_name(): string {
        return get_string('event_submission_created', 'assignsubmission_byblos');
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' linked a Byblos portfolio to assign submission with id '{$this->objectid}'.";
    }
