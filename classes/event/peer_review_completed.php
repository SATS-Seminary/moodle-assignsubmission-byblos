 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class peer_review_completed extends base {
    /**
    ...
    public static function get_name(): string {
        return get_string('event_peer_review_completed', 'assignsubmission_byblos');
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' completed a peer review of Byblos submission with id '{$this->objectid}'.";
    }
