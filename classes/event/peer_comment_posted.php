 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class peer_comment_posted extends base {
    /**
    ...
    public static function get_name(): string {
        return get_string('event_peer_comment_posted', 'assignsubmission_byblos');
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' posted an inline comment on Byblos submission with id '{$this->objectid}'.";
    }
    ...
    public function get_url(): moodle_url {
        return new moodle_url('/local/byblos/review.php', ['submissionid' => $this->objectid]);
    }
